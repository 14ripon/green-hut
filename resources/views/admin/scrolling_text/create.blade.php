        ...
        <div class="content">
            ...
            <div class="card lobicard lobicard-sortable" data-sortable="true" data-inner-id="x5dGz22KYW" data-index="4" style="display: block;">
                ...
                <div class="card-block p-3 basic-forms">
                    <form method="POST" action="{{ route('scrolling-text.store') }}">
                        @csrf

                        <div class="form-group">
                            <label for="scrolling_text">Enter text</label>
                            <input class="form-control" id="scrolling_text" type="text" name="scrolling_text" placeholder="Enter text" required>
                        </div>
                        ...
                        <button class="btn btn-base mb-3" type="submit">Save</button>
                    </form>
                </div>
            </div>
