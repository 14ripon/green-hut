        ...
        <div class="content">
            ...
            <div class="card lobicard lobicard-sortable" data-sortable="true" data-inner-id="x5dGz22KYW" data-index="4" style="display: block;">
                ...
                <div class="card-block p-3 basic-forms">
                    <form action="{{ route('office-contact.update',$contact->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label>Phone</label>
                                <input class="form-control" type="tel" name="phone" value="{{ $contact->phone }}" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label>Email</label>
                                <input class="form-control text-lowercase" type="email" name="email" value="{{ $contact->email }}" required>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                <label>Map URL</label>
                                <input class="form-control" type="text" name="map_url" value="{{ $contact->map_url }}" required>
                            </div>
                        </div>
