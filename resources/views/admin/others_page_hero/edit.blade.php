        ...
        <div class="content">
            ...
            <div class="card lobicard lobicard-sortable" data-sortable="true" data-inner-id="x5dGz22KYW" data-index="4" style="display: block;">
                ...
                <div class="card-block p-3 basic-forms">
                    ...
                    <form action="{{ route('others-page-hero.update', $hero->id) }}"
                          method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="exampleTextarea" type="text" name="title" value="{{ $hero->title }}">
                        </div>
                        <div class="form-group">
                            <label for="subtitle">Sub Title</label>
                            <input class="form-control" id="subtitle" type="text" name="sub_title" value="{{ $hero->title }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="alt" type="text" name="alt_text" value="{{ $hero->alt_text }}">
                        </div>
