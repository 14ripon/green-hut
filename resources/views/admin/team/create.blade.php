                    ...
                    <form action="{{ route('teams.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" type="text" name="alt_text" value="{{ old('alt_text') }}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" type="text" name="whats_app" value="{{ old('whats_app') }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label>Phone</label>
                        ...
                        <button class="btn btn-base" type="submit">Add Member</button>
                    </form>
