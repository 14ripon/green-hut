                ...
                <div class="card-block p-3 basic-forms">
                    <form action="{{ route('properties.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input class="form-control" type="number" step="0.01" name="land_area" value="{{ old('land_area') }}">
                        </div>
                        {{-- FLOORS --}}
                        <div class="form-group col-md-4">
                            <label>No of Floors</label>
                            <input class="form-control" type="number" name="no_of_floors" value="{{ old('no_of_floors') }}">
                        </div>
                        {{-- APARTMENT PER FLOOR --}}
                        <div class="form-group col-md-4">
                            <label>Apartment Per Floor</label>
                            <input class="form-control" type="number" name="apartment_per_floor" value="{{ old('apartment_per_floor') }}">
                        </div>

                        {{-- APARTMENT SIZE --}}
                        <div class="form-group col-md-4">
                            <label>Apartment Size</label>
                            <input class="form-control" type="text" name="apartment_size" placeholder="1200 sqft" value="{{ old('apartment_size') }}">
                        </div>
                        {{-- BEDROOMS --}}
                        <div class="form-group col-md-4">
                            <label>Bedrooms</label>
                            <input class="form-control" type="number" name="bedrooms" value="{{ old('bedrooms') }}">
                        </div>
                        <div class="form-group col-md-4">
                            <label>Bathroom</label>
                            <input class="form-control" type="number" name="bathrooms" value="{{ old('bathrooms') }}">
                        </div>
                        {{-- LAUNCH DATE NOTE --}}
                        <div class="form-group col-md-4">
                            <label>Launch Date Note</label>
                            <input class="form-control" type="text" name="launch_date_note" placeholder="Launching Soon" value="{{ old('launch_date_note') }}">
                        </div>
                        {{-- COLLECTION --}}
                        <div class="form-group col-md-4">
                            <label>Collection</label>
                            <input class="form-control" type="text" name="collection" placeholder="Luxury / Premium" value="{{ old('collection') }}">
                        </div>
                        ...
                        {{-- SUBMIT --}}
                        <div>
                            <button class="btn btn-base" type="submit">Create Property</button>
                        </div>
