                    ...
                    <form action="{{ route('testimonials.update', $testimonial->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" id="name" type="text" name="name" placeholder="Name" value="{{ $testimonial->name }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="title">Title</label>
                                <input class="form-control" id="title" type="text" name="title" placeholder="Title" value="{{ $testimonial->title }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="testimonial_subject">Testimonial Subject</label>
                                <input class="form-control" id="testimonial_subject" type="text" name="testimonial_subject" placeholder="Testimonial Subject" value="{{ $testimonial->testimonial_subject }}">
                            </div>
                            <div class="form-grou col-md-6">
                                <label for="rating">Rating</label>
                                <input class="form-control" type="range" name="rating" class="form-range" min="0" max="5" id="rating" value="{{ $testimonial->rating }}">
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="video_url" class="form-control" type="url" name="video_url" value="{{ $testimonial->video_url }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="testimonial_description">Testimonial Description</label>
                            <textarea class="form-control" id="testimonial_description" name="testimonial_description">{{ $testimonial->testimonial_description }}</textarea>
                        </div>
