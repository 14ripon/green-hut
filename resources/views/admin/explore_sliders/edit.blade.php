        ...
        <div class="content">
            ...
            <div class="card lobicard lobicard-sortable" data-sortable="true" data-inner-id="x5dGz22KYW" data-index="4" style="display: block;">
                ...
                <div class="card-block p-3 basic-forms">
                    <form method="POST"
                          action="{{ route('explore-sliders.update', $exploreSlider->id) }}"
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label>Title</label>
                                <input class="form-control" type="text" name="title" value="{{ $exploreSlider->title }}" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="">Media</label>
                                <select class="form-control" name="media_type">
                                    <option value="image" @selected($exploreSlider->media_type=='image')>Image</option>
                                    <option value="video" @selected($exploreSlider->media_type=='video')>Video</option>
                                </select>
                            </div>
                            <div class="form-group col-md-6 pl-0 checkbox checkbox-primary">
                                <input type="hidden" name="status" value="0">
                                <input id="checkbox2" type="checkbox" name="status" value="1" @checked($exploreSlider->status)>
