                    ...
                    <form action="{{ route('locations.update',$location->id) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label>City</label>
                                <input class="form-control" type="text" name="city" value="{{ $location->city }}" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label>Area</label>
                                <input class="form-control" type="text" name="area" value="{{ $location->area }}" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label>State</label>
                                <input class="form-control" type="text" name="state" value="{{ $location->state }}" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label>Country</label>
                                <input class="form-control" type="text" name="country" value="{{ $location->country }}" required>
                            </div>
                        </div>
